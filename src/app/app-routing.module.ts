...
const routes: Routes = [
    ...
    {
        path: 'error',
        loadChildren: () => import('./common/server-error/server-error.module').then((m) => m.ServerErrorModule)
    },
    {
        path: 'access-denied',
        loadChildren: () => import('./common/access-denied/access-denied.module').then((m) => m.AccessDeniedModule)
    },
